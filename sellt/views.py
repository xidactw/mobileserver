...
def App3DModelList(request):
	...
	m_Dic_List = App_3DModel_List.objects.values('tname','threeDModel__mid','threeDModel__mpath','threeDModel__id','threeDModel__bgImageName1','threeDModel__bgImageName2')
	lst = list()
	for m_Dic in m_Dic_List:
		print m_Dic
    		dic = {'id':m_Dic['threeDModel__id'],'mpath':m_Dic['threeDModel__mpath'],'mid':m_Dic['threeDModel__mid'],'img1':tmpurl+m_Dic['threeDModel__bgImageName1'],'img2':tmpurl+m_Dic['threeDModel__bgImageName2']}
    		lst.append(dic)
	rDic = {'data':lst}
	j = json.dumps(rDic)
